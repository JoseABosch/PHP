...
?>
<script src="<?php echo $actual_link;?>/public/js/jquery-3.3.1.min.js"></script>
<script src="<?php echo $actual_link;?>/public/js/bootstrap.min.js"></script>
<script src="<?php echo $actual_link;?>/public/js/jquery.magnific-popup.min.js"></script>
<script src="<?php echo $actual_link;?>/public/js/jquery.nice-select.min.js"></script>
<script src="<?php echo $actual_link;?>/public/js/jquery.slicknav.js"></script>
<script src="<?php echo $actual_link;?>/public/js/jquery-ui.min.js"></script>
<script src="<?php echo $actual_link;?>/public/js/owl.carousel.min.js"></script>
<script src="<?php echo $actual_link;?>/public/js/main.js"></script>
</body>
